...
from betinf.models import Match, Bet, Team, Game, Set, AdminBet, AdminBetVapourizer
from betinf.includes.bett import water_down, CUT
...
def show_home(request):
    ...
    return render(request, 'betinf/index.html', {
        'matches': matches,
        'games': games,
        'sets': sets,
...
def show_bet_form(request):
    ...
    user_group = user_access_level(request)
    return render(request, 'betinf/bet.html', {
        'match': match,
        'user_group': user_group
    })
...
def signIn(request):
    ...
    return render(request, 'betinf/signin.html')
...
def updateMatch(request):
    ...
    return redirect('home')
    # render(request, 'betinf/index.html', {
    #     'matches': matches,
    #     'games': games,
    #     'user_group': user_group,
    # })
...
def show_confirm_form(request):
    ...
    print("mybet  :  ", bet)
    return render(request, 'betinf/confirm.html', {
        "bet": bet
    })
...
def add_match(request):
    ...
    return render(request, 'betinf/make_match.html', {
    "teams": teams,
    "sports": sports,
    })
...
def serve_healer(request):
    ...
    if request.method=='POST':
        ...
        return render(request, 'betinf/healer_page.html', {
            "profit":profit,
            "odds":odds,
