...
if __name__ == "__main__":
    ...
    if os.path.exists(os.path.join(BASE_DIR, "reddit", "migrations")):
        shutil.rmtree(os.path.join(BASE_DIR, "reddit", "migrations"))

    if os.path.exists(os.path.join(BASE_DIR, "reddit", "__pycache__")):
        shutil.rmtree(os.path.join(BASE_DIR, "reddit", "__pycache__"))
